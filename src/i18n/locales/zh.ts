...
export const zh: LocaleCopy = {
  ...
  residenceCards: [
    ...
    },
    {
      ...
      images: [
        ...
        { alt: 'Olbia 港口鸟瞰', caption: 'Olbia 港' },
      ],
    },
    {
      title: '四足伙伴',
  ...
  gallery: {
    title: 'Le Vele 氛围',
    imageAlts: [
      '海景露台，摩卡壶与夹竹桃 — Le Vele 氛围，Stintino',
      'Residence Le Vele 花园，Stintino，地中海灌木丛',
      '寓所海景，船只与地中海灌木 — Stintino',
      '海景工作室 — Residence Le Vele，Stintino',
      '游廊配花园家具与摩卡壶 — 园景工作室 Le Vele',
      '小厨房与通往海景露台的入口 — Residence Le Vele',
      '绿化区域与游廊 — 撒丁岛度假公寓',
      '卧室细节，白色木槿与俯瞰花园的游廊 — Le Vele',
      '海景工作室室内，阳台俯瞰大海 — Le Vele，Stintino',
      '户外公共露台，躺椅与海景 — Residence Le Vele',
    ],
    closeLabel: '关闭图库',
    prevLabel: '上一张',
    nextLabel: '下一张',
