...
export const de: LocaleCopy = {
  ...
  suites: {
    'vista-giardino': {
      ...
      description:
        'Studio mit überdachter Veranda und direktem Zugang zum privaten Garten: Frühstück im Schatten, Abendessen unter der Pergola und der Duft der mediterranen Macchia.',
      features: ['Überdachte Veranda', 'Privater Garten', 'Küchenzeile', 'Kostenloses WLAN'],
      galleryAlts: [
        'Privater Garten des Studios mit Gartenblick — Residence Le Vele, Stintino',
    ...
    'vista-mare': {
      ...
      description:
        'Studio mit privater Terrasse und Blick auf die Bucht: Morgens das Licht Nord-Sardiniens, abends goldene Sonnenuntergänge Richtung La Pelosa.',
      features: ['Private Terrasse', 'Meerblick', 'Klimaanlage', 'Kostenloses WLAN'],
      galleryAlts: [
