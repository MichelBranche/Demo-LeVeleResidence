...
export const ru: LocaleCopy = {
  ...
  residenceIntro: {
    ...
    kicker: 'Между Cala Lupo и морем северо-западной Сардинии, всего в нескольких минутах от Stintino и La Pelosa.',
    lead:
      'Студии с верандой или террасой среди средиземноморской макии: апартаменты для отдыха в Stintino, в нескольких минутах от La Pelosa и моря северо-западной Сардинии. Спокойная резиденция для тех, кто ищет подлинный отдых на Сардинии.',
    marquee: ['Cala Lupo', 'La Pelosa', 'Бухты', 'Северо-запад Сардинии', 'Stintino'],
    metricsAria: 'Кратко',
  },
  residenceHighlights: [
    { value: 'Cala Lupo', label: 'Бухта' },
    { value: '~2 км', label: 'Центр и Pelosa' },
    { value: 'Знаковая', label: 'La Pelosa' },
  ],
  residenceCards: [
    {
      title: 'La Pelosa',
    ...
    },
    {
      ...
      description:
        'Residence расположена в бухте Cala Lupo, в тихом районе примерно в 2 км от центра Stintino, среди средиземноморской макии и моря северо-западной Сардинии.',
  ...
  suitesIntro: {
    ...
    count: '18',
    countLabel: 'студий',
    kicker: 'Две атмосферы — море и сад — чтобы познакомиться со Stintino с уединением резиденции.',
  ...
  suites: {
    'vista-giardino': {
      title: 'Вид на сад',
      kicker: 'Студия на 2 или 4 гостей',
      tagline: 'Веранда, частный сад и тишина средиземноморской макии.',
      description:
        'Студия с крытой верандой и выходом в частный сад: двуспальная кровать и двухъярусная кровать до 4 гостей. Обновлённые ванные комнаты — просторная душевая кабина или компактный душ с биде, в зависимости от номера.',
      features: [
        'Крытая веранда',
        'Частный сад',
      ...
      galleryAlts: [
        ...
        'Интерьер студии с видом на сад, обеденная зона и патио — Le Vele',
        ...
        'Двухъярусная кровать в студии с видом на сад — до 4 гостей',
    ...
    'vista-mare': {
      ...
      description:
        'Студия с частной террасой с видом на бухту: двуспальная кровать и двухъярусная кровать до 4 гостей, свет северо-западной Сардинии и закаты в сторону La Pelosa. Обновлённые ванные — просторный душ без биде или компактный душ с биде, в зависимости от номера.',
      features: [
        'Частная терраса',
      ...
      galleryAlts: [
        ...
        'Спальня с двуспальной кроватью и видом на море с террасы — Le Vele',
        ...
        'Двухъярусная кровать с видом на море — студия Stintino',
  ...
  seo: {
    ...
    nearbyAttractions: [
      ...
      { name: 'Бухта Cala Lupo', description: 'Тихая бухта, где расположена Residence Le Vele.' },
