...
export const ru: LocaleCopy = {
  ...
  directBookingPopup: {
    ariaLabel: 'Лучшая цена гарантирована',
    eyebrow: 'Прямое бронирование',
    title: 'Лучшее доступное предложение',
    text: 'При прямом бронировании на нашем сайте вы всегда получаете лучшее доступное предложение по лучшей цене.',
    bookCta: 'Смотреть наличие',
    closeCta: 'Понятно',
  },
  ...
  residenceCards: [
    ...
    },
    {
      ...
      images: [
        ...
        { alt: 'Вид сверху на порт Porto Torres', caption: 'Порт Porto Torres' },
      ],
    },
    {
  ...
  suitesIntro: {
    ...
    countLabel: 'студий',
    kicker:
      '18 студий двух типов — вид на море и на сад — по 2–4 места в каждой. Одно качество, два способа познакомиться со Stintino.',
    capacityNote: '18 студий всего — одна категория, два вида (море и сад).',
    capacityGrid: {
      aria: 'Обзор студий по вместимости и виду',
      sea: 'Море',
      garden: 'Сад',
      seats2: '2 места',
      seats3: '3 места',
  ...
  contactCustomOffer: {
    ...
    text: 'По особым запросам мы подготовим персональное предложение: напишите на e-mail с датами, числом гостей и предпочитаемым типом апартаментов или позвоните нам.',
  },
  contactPhotoAlts: [
