...
export const en: LocaleCopy = {
  ...
  suites: {
    'vista-giardino': {
      ...
      description:
        'Studio apartment with covered veranda and direct access to a private garden: breakfasts in the shade, dinners under the patio and the scent of Mediterranean scrubland.',
      features: ['Covered veranda', 'Private garden', 'Kitchenette', 'Free Wi-Fi'],
      galleryAlts: [
        'Private garden of the garden-view studio — Residence Le Vele, Stintino',
    ...
    'vista-mare': {
      ...
      description:
        'Studio apartment with private terrace overlooking the bay: North Sardinia light in the morning, golden sunsets towards La Pelosa in the evening.',
      features: ['Private terrace', 'Sea view', 'Air conditioning', 'Free Wi-Fi'],
      galleryAlts: [
