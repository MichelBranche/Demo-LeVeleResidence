...
export const fr: LocaleCopy = {
  ...
  suites: {
    'vista-giardino': {
      ...
      description:
        'Studio avec véranda couverte et accès direct au jardin privé : petits-déjeuners à l\'ombre, dîners sous le patio et parfum du maquis méditerranéen.',
      features: ['Véranda couverte', 'Jardin privé', 'Coin cuisine', 'Wi-Fi gratuit'],
      galleryAlts: [
        'Jardin privé du studio vue jardin — Residence Le Vele, Stintino',
    ...
    'vista-mare': {
      ...
      description:
        'Studio avec terrasse privée et vue sur la baie : lumière du Nord de la Sardaigne le matin, couchers de soleil dorés vers La Pelosa le soir.',
      features: ['Terrasse privée', 'Vue mer', 'Climatisation', 'Wi-Fi gratuit'],
      galleryAlts: [
