...
export const fr: LocaleCopy = {
  ...
  residenceCards: [
    ...
    },
    {
      ...
      images: [
        ...
        { alt: 'Vue aérienne du port de Porto Torres', caption: 'Port de Porto Torres' },
      ],
    },
    {
  ...
  suitesIntro: {
    ...
    countLabel: 'studios',
    kicker:
      '18 studios en deux typologies — vue mer et vue jardin — de 2 à 4 personnes chacun. Même qualité, deux façons de vivre Stintino.',
    capacityNote: '18 studios au total — même catégorie, deux vues (mer et jardin).',
    capacityGrid: {
      aria: 'Vue d\'ensemble des studios par capacité et vue',
      sea: 'Mer',
      garden: 'Jardin',
      seats2: '2 personnes',
      seats3: '3 personnes',
  ...
  suites: {
    'vista-giardino': {
      ...
      galleryAlts: [
        ...
        'Table à manger en véranda avec moka et vue jardin — studio vue jardin Le Vele',
    ...
    'vista-mare': {
      ...
      galleryAlts: [
        ...
        'Terrasse aménagée avec vue sur le studio et la mer — Le Vele',
        'Studio vue mer avec terrasse et lumière sur la baie — Residence Le Vele',
        'Terrasse couverte avec table, moka et vue mer — studio Le Vele',
        'Petit-déjeuner en terrasse avec moka et oleander — vue mer Stintino',
  ...
  residenceWelcome: {
    ...
    autoplayLabel: 'Parcourir les photos',
  },
  offers: {
  ...
  contactPhotoAlts: [
    ...
    'Coucher de soleil sur le promontoire de la Residence Le Vele — Stintino, Sardaigne',
    'Vue aérienne de la Residence Le Vele avec appartements et mer — Stintino, Sardaigne',
  ],
  siteMap: {
  ...
  seo: {
    ...
    contact: {
      title: 'Residence Le Vele | Contact & accès',
      description:
        'Téléphone, e-mail et itinéraire pour la Residence Le Vele à Stintino : réservations et demandes pour appartements de vacances en Sardaigne.',
      keywords:
        'contact residence stintino, accès le vele, téléphone réservation stintino, appartement vacances sardaigne',
      breadcrumb: 'Contact',
    },
    pelosa: {
