...
export const es: LocaleCopy = {
  ...
  suites: {
    'vista-giardino': {
      ...
      description:
        'Estudio con veranda cubierta y acceso directo al jardín privado: desayunos a la sombra, cenas bajo el porche y el aroma de la macchia mediterránea.',
      features: ['Veranda cubierta', 'Jardín privado', 'Rincón cocina', 'Wi-Fi gratuito'],
      galleryAlts: [
        'Jardín privado del estudio con vista jardín — Residence Le Vele, Stintino',
    ...
    'vista-mare': {
      ...
      description:
        'Estudio con terraza privada y vistas a la bahía: luz del norte de Cerdeña por la mañana, atardeceres dorados hacia La Pelosa por la tarde.',
      features: ['Terraza privada', 'Vista mar', 'Aire acondicionado', 'Wi-Fi gratuito'],
      galleryAlts: [
