...
export const es: LocaleCopy = {
  ...
  residenceCards: [
    ...
    },
    {
      ...
      images: [
        ...
        { alt: 'Vista aérea del puerto de Porto Torres', caption: 'Puerto de Porto Torres' },
      ],
    },
    {
  ...
  suitesIntro: {
    ...
    countLabel: 'estudios',
    kicker:
      '18 estudios en dos tipologías — vista mar y vista jardín — de 2 a 4 plazas cada uno. Misma calidad, dos formas de vivir Stintino.',
    capacityNote: '18 estudios en total — misma categoría, dos vistas (mar y jardín).',
    capacityGrid: {
      aria: 'Panorámica de estudios por plazas y vista',
      sea: 'Mar',
      garden: 'Jardín',
      seats2: '2 plazas',
      seats3: '3 plazas',
  ...
  suites: {
    'vista-giardino': {
      ...
      galleryAlts: [
        ...
        'Mesa de comedor en veranda con moka y vista al jardín — estudio vista jardín Le Vele',
    ...
    'vista-mare': {
      ...
      galleryAlts: [
        ...
        'Terraza amueblada con vista al estudio y al mar — Le Vele',
        'Estudio con vista mar y terraza sobre la bahía — Residence Le Vele',
        'Terraza cubierta con mesa, moka y vista al mar — estudio Le Vele',
        'Desayuno en terraza con moka y adelfa — vista mar Stintino',
  ...
  contactCustomOffer: {
    ...
    text: 'Para solicitudes específicas puede pedirnos un presupuesto a medida: escríbanos por correo con las fechas, el número de huéspedes y la tipología preferida, o llámenos por teléfono.',
  },
  contactPhotoAlts: [
    'Vista aérea de la costa de Stintino con piscina y calas — Residence Le Vele',
    'Atardecer sobre el promontorio del Residence Le Vele — Stintino, Cerdeña',
    'Vista aérea del Residence Le Vele con apartamentos y mar — Stintino, Cerdeña',
  ],
  siteMap: {
