...
const privacyByLang: Record<SiteLocale, LegalDoc> = {
  ...
  ru: {
    ...
    sections: [
      {
        h: '1. Оператор данных',
        body: <DataControllerBlock locale="ru" />,
      },
      {
        h: '2. Собираемые данные',
        body: (
          <ul>
            <li>Контактные данные через формы или email (имя, email, телефон, сообщение).</li>
            <li>Запросы на бронирование или наличие номеров.</li>
            <li>Технические данные навигации (IP, браузер, страницы) только с согласия на аналитику.</li>
            <li>Предпочтения cookie (категории, время, версия политики, хеш целостности).</li>
          </ul>
        ),
      },
      {
        ...
        body: (
          <ul>
            <li>
              <strong>Запросы и бронирования</strong> — преддоговорные меры и договор (ст. 6(1)(b) GDPR).
            </li>
            <li>
              <strong>Информационные сообщения</strong> — законный интерес или согласие (ст. 6(1)(f) / (a)).
            </li>
            <li>
              <strong>Аналитика и маркетинг</strong> — только с явного согласия (ст. 6(1)(a)).
            </li>
            <li>
              <strong>Безопасность и работа сайта</strong> — законный интерес (ст. 6(1)(f)).
            </li>
          </ul>
        ),
      },
      {
        ...
        body: (
          <p>
            Контактные данные хранятся столько, сколько необходимо для обработки запроса и выполнения
            юридических обязательств. Аналитические журналы — согласно срокам провайдера. Согласие на cookie
            сохраняется до 12 месяцев или до отзыва.
          </p>
        ),
      },
      {
        h: '5. Получатели и передача',
        body: (
          <p>
            Данные могут обрабатываться техническими провайдерами (хостинг, email, аналитика) как
            обработчиками. Передача за пределы ЕС — только с надлежащими гарантиями.
          </p>
        ),
      },
      {
        ...
        body: (
          <ul>
            <li>Доступ, исправление, удаление, ограничение, возражение, переносимость.</li>
            <li>Отзыв согласия в любое время без влияния на ранее законную обработку.</li>
            <li>Жалоба в надзорный орган.</li>
          </ul>
        ),
      },
      {
        h: '7. Cookie и отслеживание',
        body: (
          <p>
            Подробнее в нашей <Link to="/cookie-policy">Политике cookie</Link>. Необязательные cookie не
            активируются без вашего согласия.
          </p>
        ),
      },
    ],
  ...
  zh: {
    ...
    sections: [
      {
        h: '1. 数据控制者',
        body: <DataControllerBlock locale="zh" />,
      },
      {
        h: '2. 收集的数据',
        body: (
          <ul>
            <li>通过表单或电子邮件提交的联系方式（姓名、邮箱、电话、留言）。</li>
            <li>预订或空房查询请求。</li>
            <li>仅在同意分析的情况下收集浏览技术数据（IP、浏览器、访问页面）。</li>
            <li>Cookie 同意偏好（类别、时间戳、政策版本及完整性哈希）。</li>
          </ul>
        ),
      },
      {
        ...
        body: (
          <ul>
            <li>
              <strong>咨询与预订</strong> — 合同前措施与合同履行（GDPR 第6条(1)(b)款）。
            </li>
            <li>
              <strong>信息沟通</strong> — 合法利益或同意（第6条(1)(f)/(a)款）。
            </li>
            <li>
              <strong>分析与营销</strong> — 仅在明确同意后（第6条(1)(a)款）。
            </li>
            <li>
              <strong>网站安全与运行</strong> — 合法利益（第6条(1)(f)款）。
            </li>
          </ul>
        ),
      },
      {
        ...
        body: (
          <p>
            联系数据在处理请求所需期间及法律义务要求的期限内保留。分析日志遵循服务商保留政策。Cookie
            同意保存最长12个月或直至撤回。
          </p>
        ),
      },
      {
        ...
        body: (
          <p>
            数据可能由技术服务商（托管、邮件、分析）作为处理者处理。向欧盟以外传输仅在具备适当保障措施时进行。
          </p>
        ),
      },
      {
        ...
        body: (
          <ul>
            <li>访问、更正、删除、限制、反对、数据可携带。</li>
            <li>随时撤回同意，不影响此前合法处理。</li>
            <li>向监管机构投诉。</li>
          </ul>
        ),
      },
      {
        ...
        body: (
          <p>
            详见我们的 <Link to="/cookie-policy">Cookie 政策</Link>。未经同意不会启用非必要 Cookie。
          </p>
        ),
      },
    ],
