...
const navByLocale: Record<SiteLocale, NavLinkItem[]> = {
  it: [
    ...
    { label: 'Info & condizioni', to: '/#info-servizi' },
  ...
  en: [
    ...
    { label: 'La Pelosa', to: '/la-pelosa' },
    { label: 'Info & conditions', to: '/#info-servizi' },
  ...
  de: [
    ...
    { label: 'La Pelosa', to: '/la-pelosa' },
    { label: 'Info & Bedingungen', to: '/#info-servizi' },
  ...
  es: [
    ...
    { label: 'La Pelosa', to: '/la-pelosa' },
    { label: 'Info y condiciones', to: '/#info-servizi' },
